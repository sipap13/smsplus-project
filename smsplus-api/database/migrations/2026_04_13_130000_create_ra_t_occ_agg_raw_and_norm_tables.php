...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('ra_t_occ_agg_raw', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('charge_amount_raw', 40)->nullable(); // ex: 1,1
            $table->timestamps();
        ...
        // Normalized OCC aggregate table
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('ra_t_occ_agg_raw');
    }
};
